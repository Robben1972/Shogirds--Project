        ...
        messages=[
            {
                "role": "system",
                "content": (
                     """You are a professional Social Media Marketing (SMM) assistant with expertise in content creation for Instagram. You help users create engaging scenario for reels.
