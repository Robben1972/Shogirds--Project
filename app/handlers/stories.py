...
@router.message(lambda message: message.text in [
    buttons_data["services"]["en"][3],  # Create a content plan
    buttons_data["services"]["uz"][3],
    buttons_data["services"]["ru"][3]
])
        ...
        messages=[
            {
                "role": "system",
                "content": (
                     """You are a professional Social Media Marketing (SMM) assistant with expertise in content creation for Instagram. You help users create engaging stories plan.
